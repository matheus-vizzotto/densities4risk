...
for ii=2:d0
    ...
    vecGS = zeros(d0,1);
    for jj=1:(ii-1)
        vecGS(jj) = FuncInnerProd(fh_OrtNormEigFunc{jj},fh_EigFunc{ii},0,1)/FuncInnerProd(fh_OrtNormEigFunc{jj},fh_OrtNormEigFunc{jj},0,1);
    end
...
for ii=1:d0
    ...
    innprod = FuncInnerProd(fh_OrtNormEigFunc{ii},fh_OrtNormEigFunc{ii},0,1);
