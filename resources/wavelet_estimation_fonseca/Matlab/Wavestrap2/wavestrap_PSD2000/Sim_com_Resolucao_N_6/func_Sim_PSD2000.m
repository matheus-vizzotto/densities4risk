function [ vDimSel, mEigval, mPvalues ] = func_Sim_PSD2000(n,d,NREP,Nboot)
...
% N=3 teremos armazenados os níveis de detalhes 7, 6, 5, 4, 3 e 2.
N = 6;
wname = 'db4';  % base de ondaletas utilizada
p = 5;  % lag máximo utilizado
J = 294;  % número de coefientes da base de ondaletas usada
...
for kk=1:NREP
    ...
    while d0<=8
        ...
        % empírica bootstrap do (d0+1)-ésimo maior autovalor de D
        d_boot = DimEst_wavestrap_PSD2000( A, Lw, Nboot, B(:,[1:d0]), p);
