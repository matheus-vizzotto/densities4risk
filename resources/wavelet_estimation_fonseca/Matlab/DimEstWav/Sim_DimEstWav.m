...
NREP_boot = 100;  % número de réplicas bootstrap
...
model_xi1 = arima('Constant',0,'AR',{-.8167},'Variance',1.5);
model_xi2 = arima('Constant',0,'AR',{.7333},'Variance',1.5);
model_xi3 = arima('Constant',0,'AR',{-.65},'Variance',1.5);
model_xi4 = arima('Constant',0,'AR',{.5667},'Variance',1.5);
...
while d0<=8
    ...
    % função DimEst_boot
    d_boot = DimEst_boot( Y, NREP_boot, B(:,[1:d0]), p, N, 'db2');
...
save('file_Sim_DimEstWav_n600d6.mat','vDimSel','mPvalues','mEigval');  
%file = matfile('file_Sim_DimEstWav_n100d2.mat');
