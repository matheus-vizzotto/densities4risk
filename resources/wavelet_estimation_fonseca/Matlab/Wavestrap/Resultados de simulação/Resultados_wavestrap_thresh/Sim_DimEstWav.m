...
while d0<=8
    ...
    % função DimEst_boot
    d_boot = DimEst_wavestrap_thresh( A, Nboot, B(:,[1:d0]), p, N, wname);
...
save('file_Sim_wavestrap_d6.mat','vDimSel_n100','mPvalues_n100','mEigval_n100',...
    'vDimSel_n300','mPvalues_n300','mEigval_n300',...
    'vDimSel_n600','mPvalues_n600','mEigval_n600');  
%file = matfile('file_Sim_wavestrap_d6.mat');
