...
tic
parfor k=1:NREP
    [vDimSel(k),mEQMI_n(k,:),mEQMI_nt(k,:),mEigval(k,:),mPvalues(k,:)] = func_Sim_DimEstWav(n,d,1,Nboot);
end
toc
...
save('file_Sim_wavestrap_d2.mat','vDimSel_n100','mPvalues_n100','mEigval_n100','mEQMI_n_n100','mEQMI_nt_n100',...
...
% salvando as matrizes
save('file_Sim_wavestrap_d4.mat','vDimSel_n100','mPvalues_n100','mEigval_n100','mEQMI_n_n100','mEQMI_nt_n100',...
    'vDimSel_n300','mPvalues_n300','mEigval_n300','mEQMI_n_n300','mEQMI_nt_n300',...
    'vDimSel_n600','mPvalues_n600','mEigval_n600','mEQMI_n_n600','mEQMI_nt_n600');  
...
% salvando as matrizes
save('file_Sim_wavestrap_d6.mat','vDimSel_n100','mPvalues_n100','mEigval_n100','mEQMI_n_n100','mEQMI_nt_n100',...
    'vDimSel_n300','mPvalues_n300','mEigval_n300','mEQMI_n_n300','mEQMI_nt_n300',...
    'vDimSel_n600','mPvalues_n600','mEigval_n600','mEQMI_n_n600','mEQMI_nt_n600');  
